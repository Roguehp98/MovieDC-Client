        ...
        return (
            <div>
                ...
                <div className="container-fluid text-white" >
                    <div className="row" >
                        <div className="col-md col-xl col-sm fewNews" >
                        ...
                        <div className="col-md col-xl col-sm">
                            <div className="row">
                                <div className="col-md col-sm fewNews" >
                                ...
                                <div className="col-md col-sm fewNews" >
                                    <a href="https://www.warnerbros.com/news/articles/2019/05/23/cws-new-2019-2020-schedule" target="_blank" rel="noopener noreferrer" style={{color:"white"}}>
                                        <img src="https://irs.www.warnerbros.com/promo-jpeg/promopod/media/browser/CW_1920x1536.jpg" className="card-img" alt="CW News" style={{height:"250px",width:"100%"}}/>
                                        <div className="card-img-overlay" style={{display:"flex", flexDirection:"column",justifyContent:"flex-end", paddingLeft:"1.375rem"}} >
                                            <div style={{borderLeft:"0.1rem solid rgba(255, 255, 255, 0.4)", paddingLeft:"1rem"}}>
                                                <p className="card-title" style={{fontSize: "0.75rem"}}>May 23, 2019</p>
                                                <p className="card-text" style={{letterSpacing:"1px", fontSize:"1.25rem!important",textShadow:"0px 1px, 1px 0px, 1px 1px", fontWeight:"bold", lineHeight:"1.25rem"}}>The CW's New Fall Schedule.</p>
                                                <p className="card-text" style={{fontSize:"0.75rem", lineHeight:"1rem",fontWeight:"800"}}>2019 - 2020 New and Returning Series Announced</p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
